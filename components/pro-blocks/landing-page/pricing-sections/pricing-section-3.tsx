  ...
  plans: [
    {
      name: "Standard",
      description:
        "Perfect for small businesses looking to expand their sales reach.",
      features: [
        { name: "Single market focus", tooltip: "Choose UK, US, or Australia" },
        {
          name: "Lead qualification",
          tooltip: "Basic lead qualification services",
        },
        { name: "Monthly reporting", tooltip: "Performance reports each month" },
      ],
      price: 999,
      period: "/month",
      variant: "outline",
    },
    {
      name: "Enterprise",
      description:
        "Comprehensive solution for businesses targeting multiple markets.",
      features: [
        { name: "Multi-market coverage", tooltip: "Access to all markets: UK, US, and Australia" },
        { name: "Advanced lead scoring", tooltip: "Detailed lead qualification and scoring" },
        { name: "Dedicated account manager", tooltip: "Personalized service and strategy" },
        { name: "Weekly reporting", tooltip: "Detailed performance analytics" },
      ...
      <div className="container-padding-x container mx-auto">
        <div className="flex flex-col items-center gap-10 md:gap-12">
          ...
          <div className="section-title-gap-lg flex max-w-xl flex-col items-center text-center">
            ...
            >
              Flexible BPO solutions for your business
            </h2>
          </div>
