      ...
      <div className="container-padding-x container mx-auto flex flex-col gap-10 md:gap-12">
        ...
        <div className="section-title-gap-lg mx-auto flex max-w-xl flex-col items-center text-center">
          ...
          <h2 className="heading-lg">
            Comprehensive BPO Solutions for Global Markets
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3 md:gap-6 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <Card className="bg-muted/80 gap-0 overflow-hidden rounded-xl border-none p-0 shadow-none lg:col-span-2">
            ...
            <CardContent className="flex flex-col gap-2 p-6">
              ...
              <p className="text-muted-foreground">
                Targeted campaigns to identify and qualify potential clients
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-muted/80 gap-0 overflow-hidden rounded-xl border-none p-0 shadow-none lg:col-span-1">
            ...
            <CardContent className="flex flex-col gap-2 p-6">
              ...
              <p className="text-muted-foreground">
                Expert sales teams to convert leads into customers
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-muted/80 gap-0 overflow-hidden rounded-xl border-none p-0 shadow-none lg:col-span-1">
            ...
            <CardContent className="flex flex-col gap-2 p-6">
              ...
              <p className="text-muted-foreground">
                Insights into UK, US, and Australian market trends
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-muted/80 gap-0 overflow-hidden rounded-xl border-none p-0 shadow-none lg:col-span-2">
            ...
            <CardContent className="flex flex-col gap-2 p-6">
              ...
              <p className="text-muted-foreground">
                Multilingual support for global client management
              </p>
            </CardContent>
          </Card>
        </div>
